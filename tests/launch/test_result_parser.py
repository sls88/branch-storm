...
@pytest.mark.parametrize(
    ...
    [
        ...
        ((STOP_ALL_FURTHER_OPERATIONS_WITH_SUCCESS,), {"tc": tc}, ((), True, {"tc": tc})),
        ((new_tc,), {"tc": tc}, ((), False, {"tc": new_tc})),
        ((new_tc, STOP_ALL_FURTHER_OPERATIONS_WITH_SUCCESS), {"tc": tc}, ((), True, {"tc": new_tc})),
        ...
        ((1, new_tc, 2, STOP_ALL_FURTHER_OPERATIONS_WITH_SUCCESS, new_stc), {"tc": tc, "stc": stc},
...
def test_sort_data(data: Tuple, rw_inst: Dict[str, Any], expected_result: Tuple[Tuple, Dict[str, Any]]):
    ...
    actual_result = sd.data, sd.stop_all_further_operations_with_success, new_rw_inst
